...
class Config:
    def __init__(
        ...
        self.__show_current_cloudchannel = show_current_cloudchannel
    ...
    @property
    def new_cloudchannel(self):
        return self.__new_cloudchannel
    ...
    @property
    def show_current_cloudchannel(self):
        return self.__show_current_cloudchannel
